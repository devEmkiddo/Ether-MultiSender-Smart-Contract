...
contract MultiSendErc20{
    ...
    function multiSendTokens(address[] memory myAddr, uint256 amount) external onlyOwner noReentrancy{
        ...
        {
            require(token.transfer(myAddr[i], amount), "Failed");
        }
    }
    ...
    function withdrawTokens() external onlyOwner{
       uint256 contractBal = token.balanceOf(address(this));
        ...
        require(token.transfer(owner, contractBal), "Failed");
